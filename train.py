...
flags.DEFINE_string('label_file_path', None, 'Path of training dataset label file.')
...
flags.DEFINE_boolean('transpose_conv', False, 'Whether to use Conv2DTranspose as upsample layer.')
...
def main(argv):
    FLAGS.logdir = "log/retina"
    FLAGS.label_file_path = "data/CHASEDB/training.txt"
    FLAGS.batch_size = 4
    FLAGS.max_iters = 2000
    FLAGS.preprocess = True
    FLAGS.transpose_conv = True
